...
export default function Home(){
  ...
  return <div className="v20-home">
    <section className="v20-hero">
      <img className="v20-hero-paper" src={asset("/assets/hero-background-wide.webp")} alt="" aria-hidden="true"/>
      ...
      <div className="v20-hero-art"><img className="v20-cart" src={asset("/assets/cart.webp")} alt="Illustrated Thindi Angadi snack cart"/><span className="v20-seal">ಹೃದಯದಿಂದ<br/><b>ನಿಮ್ಮ ಮನೆಗೆ</b></span></div>
    ...
    <section className="v20-proof v20-section"><div className="v20-proof-copy"><span className="v20-kicker">✦ WHY THINDI ANGADI</span><h2>Not just <em>snacks</em>.<br/>A taste of where<br/>they’re from.</h2><p>Every thindi has a place. Every place has its own way of making it. Thindi Angadi brings Karnataka&apos;s regional flavours together in one angadi — while staying rooted in the taste and traditions that made them special.</p><Link className="v20-button red" href="/regions">Explore Karnataka</Link></div><figure className="v20-torn-photo v20-vada-photo"><img src={asset("/assets/why-thindi-angdi-vada.png")} alt="Three crisp vadas served on a banana leaf with curry leaves and onion" loading="lazy"/></figure></section>
